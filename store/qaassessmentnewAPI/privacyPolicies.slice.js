...
export const modules_privacy_policy_list = createAsyncThunk("privacyPolicies/modules_privacy_policy_list", async payload => {
  const response = await apiService.modules_privacy_policy_list(payload);
  return response.data;
});
export const modules_privacy_policy_create = createAsyncThunk("privacyPolicies/modules_privacy_policy_create", async payload => {
  const response = await apiService.modules_privacy_policy_create(payload);
  return response.data;
});
export const modules_privacy_policy_retrieve = createAsyncThunk("privacyPolicies/modules_privacy_policy_retrieve", async payload => {
  const response = await apiService.modules_privacy_policy_retrieve(payload);
  return response.data;
});
export const modules_privacy_policy_update = createAsyncThunk("privacyPolicies/modules_privacy_policy_update", async payload => {
  const response = await apiService.modules_privacy_policy_update(payload);
  return response.data;
});
export const modules_privacy_policy_partial_update = createAsyncThunk("privacyPolicies/modules_privacy_policy_partial_update", async payload => {
  const response = await apiService.modules_privacy_policy_partial_update(payload);
  return response.data;
});
export const modules_privacy_policy_destroy = createAsyncThunk("privacyPolicies/modules_privacy_policy_destroy", async payload => {
